...
public class BorrowBook extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextField1.setBounds(240, 40, 190, 30);
        ...
        jTextField2.setBounds(240, 120, 190, 30);

        jLabel3.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel3.setText("Borrow Date(YYYY-MM-DD)");
        jPanel1.add(jLabel3);
        jLabel3.setBounds(60, 210, 200, 30);

        jTextField3.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jPanel1.add(jTextField3);
        jTextField3.setBounds(260, 210, 170, 30);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       if (ID.length() == 0 || rollnumber.length() == 0 || Date.length() == 0)
           ...
           if(obj.IssueBook(new BookIssue(ID, rollnumber, Date)))
               JOptionPane.showMessageDialog(null, "Book borrowed for 10 days");
           else
